...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "shivam.khatri2345@gmail",
    href: "mailto:shivam.khatri2345@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/shivam-khatri/",
    content: "/shivam-khatri",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Shivam-Khatri",
    content: "/shivam-khatri",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Shivam</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Shivam, a Fullstack developer passionate about
